...
pub fn example_relation() -> Relation {
    ...
    Relation {
        ...
        directives: vec![
            ...
            Directive::Gate(Public(type_id_7, WireRange::singleton(0))),
            Directive::Gate(Private(type_id_7, WireRange::singleton(1))),
            Directive::Gate(Private(type_id_7, WireRange::singleton(2))),
            Directive::Gate(Convert(type_id_101, 0, 0, type_id_7, 0, 0, false)),
            Directive::Gate(Convert(type_id_101, 1, 1, type_id_7, 1, 1, false)),
            Directive::Gate(Convert(type_id_101, 2, 2, type_id_7, 2, 2, false)),
            ...
            Directive::Gate(Private(type_id_ring, WireRange::singleton(0))),
            Directive::Gate(Private(type_id_ring, WireRange::singleton(1))),
            Directive::Gate(Private(type_id_ring, WireRange::singleton(2))),
            Directive::Gate(Call(
                "ring_add".to_string(),
                vec![WireRange::new(3, 3)],
            ...
            Directive::Gate(Public(type_id_ring, WireRange::singleton(5))),
            Directive::Gate(Call(
                "ring_equal".to_string(),
                vec![],
